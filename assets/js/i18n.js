...
const I18n = (() => {
  ...
  const _vi = {
    ...
    'admin.system.export.title':'Trích xuất database','admin.system.export.sub':'Xuất toàn bộ schema và dữ liệu ra file .sql để backup hoặc khôi phục.',
    'admin.system.export.refresh':'Làm mới','admin.system.export.download':'Tải file dump (.sql)','admin.system.export.loading':'Đang tải…',
    'admin.system.export.meta.database':'Database:','admin.system.export.meta.tables':'Số bảng:','admin.system.export.meta.rows':'Tổng số dòng:',
    'admin.system.export.th.table':'Tên bảng','admin.system.export.th.rows':'Số dòng',
    'admin.system.export.warn':'⚠️ File dump có thể chứa thông tin nhạy cảm (token API, hash mật khẩu, dữ liệu khách hàng). Hãy bảo quản cẩn thận.',
    ...
    'analytics.filters.clear':'Xóa lọc',
    'analytics.filters.sub':'Lọc riêng heatmap và biểu đồ địa phương theo SKU sản phẩm hoặc thương hiệu.',
    'analytics.filters.title':'Bộ lọc phân tích',
    'brand.btn.add_row':'Thêm dòng',
    'brand.lines_unit':'dòng',
    'brand.load_error':'Không thể tải quy ước thương hiệu.',
    'brand.loading':'Đang tải quy ước thương hiệu...',
    'brand.preview.empty':'Chưa có quy ước nào',
    'brand.preview.example':'Ví dụ',
    'brand.save_error':'Không thể lưu quy ước thương hiệu.',
    'brand.saved':'Đã lưu quy ước thương hiệu.',
    'brand.th.brand_name':'Tên thương hiệu',
    'brand.th.sku_code':'Mã SKU 3 ký tự',
    'cl.lazada_excluded':'Các tỉnh còn lại',
    'cl.location_note':'Chỉ tính Shopee & TikTok Shop — Lazada không có thông tin địa chỉ',
    'cl.other_provinces':'Tỉnh / TP khác',
    'connect.guide.lazada':'Hướng dẫn kết nối Lazada',
    'connect.guide.shopee':'Hướng dẫn kết nối Shopee',
    'connect.guide.tiktok':'Hướng dẫn kết nối TikTok Shop',
    'filter.all_brands':'Tất cả thương hiệu',
    'filter.all_products':'Tất cả sản phẩm',
    'filter.brand_prefix':'thương hiệu',
    'filter.current_sku':'Đang chọn',
    'gbs.btn.add_file':'Thêm file GBS',
    'gbs.btn.confirm':'Xác nhận tháng',
    'gbs.btn.confirm_period':'Xác nhận kỳ',
    'gbs.btn.export':'Xuất đơn chưa khớp',
    'gbs.btn.unconfirm_period':'Bỏ xác nhận kỳ',
    'gbs.confirm.error':'Không thể cập nhật trạng thái tháng đối soát',
    'gbs.confirmed_at':'Xác nhận lúc',
    'gbs.empty.no_gbs_months':'Chưa có tháng GBS nào được nhận diện. Upload file GBS để hệ thống tự gom tháng.',
    'gbs.empty.no_intersection':'Chưa có đơn giao nhau trong kỳ này.',
    'gbs.empty.no_months':'Chưa có tháng đối soát nào sẵn sàng.',
    'gbs.empty.not_confirmed':'Tháng này chưa được xác nhận hoàn tất.',
    'gbs.files.sub':'Theo dõi file đã upload, tháng nhận diện được và xoá từng file sau khi hoàn tất đối soát.',
    'gbs.files.title':'Quản lý file GBS',
    'gbs.kicker.months':'Các Kỳ GBS',
    'gbs.kicker.period':'Kỳ Đối Soát',
    'gbs.kicker.rules':'Nguyên Tắc Khớp',
    'gbs.kicker.summary':'Tổng Quan',
    'gbs.kpi.intersection':'Đơn giao nhau',
    'gbs.kpi.intersection.sub':'Có mặt đồng thời trong GBS và dữ liệu sàn chung',
    'gbs.kpi.matched':'Đơn khớp',
    'gbs.kpi.matched.sub':'Khớp số lượng và NMV sau khi quy đổi',
    'gbs.kpi.platform_orders':'Đơn sàn trong phạm vi',
    'gbs.kpi.platform_orders.sub':'Dữ liệu lấy từ bảng orders theo logic thời gian của từng sàn',
    'gbs.kpi.review':'Đơn cần xem',
    'gbs.kpi.review.sub':'Bao gồm đơn thiếu ở một phía hoặc lệch sau đối chiếu',
    'gbs.mapping.kicker':'Quy Tắc Dữ Liệu',
    'gbs.mapping.sub':'Mở ra khi cần kiểm tra cách GBS được quy đổi và khớp với dữ liệu orders chung.',
    'gbs.mapping.title':'Quy tắc đối soát theo sàn',
    'gbs.mapping.view_detail':'Xem chi tiết',
    'gbs.months.sub':'Hệ thống tự gom tháng từ toàn bộ file GBS, chọn nhanh từng kỳ để đối soát.',
    'gbs.months.title':'Danh sách tháng GBS',
    'gbs.order.platform_time':'Mốc sàn',
    'gbs.period.confirmed':'Đã chốt kỳ',
    'gbs.period.open':'Đang mở kỳ',
    'gbs.period.select_detail':'Chọn để xem chi tiết',
    'gbs.period.sub':'Chọn tháng GBS để xác nhận kỳ và xuất danh sách đơn lệch.',
    'gbs.period.title':'Tháng đang xem',
    'gbs.period.viewing':'Đang xem kỳ này',
    'gbs.platform.kicker':'Chi Tiết Theo Sàn',
    'gbs.platform.sub':'Mỗi sàn được thu gọn riêng để giảm chiều dài trang và tập trung vào các phần có chênh lệch.',
    'gbs.platform.title':'Bảng đối chiếu chi tiết',
    'gbs.result.bundle_match':'Khớp combo',
    'gbs.result.matched':'Khớp',
    'gbs.result.mismatch':'Lệch',
    'gbs.result.missing_gbs':'Thiếu GBS',
    'gbs.result.missing_platform':'Thiếu dữ liệu sàn',
    'gbs.result.order_match':'Khớp đơn',
    'gbs.rules.combo':'Quy đổi combo về SKU lẻ và phân bổ NMV bằng dữ liệu trong trang SKU & Combo.',
    'gbs.rules.match_key':'Khóa khớp',
    'gbs.rules.match_key_desc':'Đối chiếu theo `platform + order_id`, ưu tiên dữ liệu orders chung để tránh upload trùng.',
    'gbs.rules.shopee':'Shopee khớp theo `Giá ưu đãi - Mã giảm giá của Shop` và chỉ trừ voucher shop 1 lần / đơn; GBS làm tròn tiền trước khi so sánh.',
    'gbs.rules.title':'Đối soát GBS theo tháng trên cùng một nguồn dữ liệu đơn hàng',
    'gbs.run.not_loaded':'Chưa tải dữ liệu đối soát.',
    'gbs.stat.by':'bởi',
    'gbs.stat.coverage':'Độ phủ khớp',
    'gbs.stat.unmatched':'Chưa khớp',
    'gbs.stat.zero_months':'0 tháng',
    'gbs.summary.sub':'So sánh nhanh số lượng đơn GBS và orders chung theo từng sàn trong tháng đã chọn.',
    'gbs.summary.title':'Tóm tắt theo sàn',
    'gbs.th.actions':'Thao tác',
    'gbs.th.common_orders':'Đơn chung',
    'gbs.th.detected_month':'Tháng nhận diện',
    'gbs.th.gbs_orders':'Đơn GBS',
    'gbs.th.gbs_qty_nmv':'SL / NMV GBS',
    'gbs.th.platform_qty_nmv':'SL / NMV sàn',
    'gbs.th.platform_time':'Thời gian sàn',
    'gbs.th.rows_orders':'Dòng / Đơn',
    'gbs.th.size':'Kích thước',
    'gbs.th.updated':'Cập nhật',
    'gbs.unmatched.kicker':'Cần Xử Lý',
    'gbs.unmatched.sub':'Gồm đơn thiếu ở GBS hoặc còn lệch số lượng / NMV. Có thể xuất toàn bộ danh sách theo tháng đang xem.',
    'gbs.unmatched.title':'Đơn sàn chưa khớp với GBS',
    'gbs.unmatched.zero':'0 đơn',
    'gbs.updated_at':'Cập nhật',
    'gbs.upload.note.file_month':'File tháng',
    'gbs.upload.note.file_month_desc':'Tự nhận diện theo `Thời gian đối soát`, lưu nhiều file và xoá khi không còn dùng.',
    'gbs.upload.note.lazada_source':'Khớp tháng theo `ttsSla` đã đồng bộ vào hệ thống.',
    'gbs.upload.note.match_key':'Đối chiếu mã đơn',
    'gbs.upload.note.match_key_desc':'Hiện ưu tiên khớp theo mã đơn vì chưa có mốc thời gian ổn định.',
    'gbs.upload.note.platform_source':'Nguồn orders chung',
    'gbs.upload.note.shopee_source':'Khớp tháng theo `Thời gian hoàn thành đơn hàng`.',
    'gbs.upload.sub':'GBS quản lý riêng theo file tháng. Dữ liệu sàn lấy trực tiếp từ `orders`, không cần upload lại.',
    'gbs.upload.title':'Upload file GBS theo tháng',
    'log.all_categories':'Tất cả danh mục',
    'log.all_levels':'Tất cả mức',
    'log.category':'Danh mục',
    'log.clear':'Xoá log',
    'log.level':'Mức',
    'log.message':'Thông điệp',
    'log.search':'Tìm kiếm...',
    'msg.no_admin_access':'Bạn không có quyền truy cập khu quản trị.',
    'plan.error.load_failed':'Không tải được kế hoạch',
    'plan.updated_at':'Cập nhật',
    'reconcile.error.load_settings':'Không thể tải cài đặt đối soát.',
    'system.data_stats.title':'Thống kê dữ liệu',
    'system.info.title':'Thông tin hệ thống',
    'system.update.title':'Cập nhật tự động',
    'th.account':'Tài khoản',
    'th.actions':'Thao tác',
    'th.country':'Quốc gia',
    'th.file':'File',
    'th.from_date':'Từ ngày',
    'th.imported':'Đã import',
    'th.last_synced':'Đồng bộ lần cuối',
    'th.region':'Khu vực',
    'th.skipped':'Bỏ qua',
    'th.time':'Thời gian',
    'th.token_expires':'Token hết hạn',
    'th.type':'Loại',
    'unit.orders':'đơn',
    'upload.area.hint':'Hỗ trợ .xlsx và .xls — nhiều file cùng lúc, tự nhận diện đúng mẫu traffic Shopee / Lazada / TikTok Shop khi upload',
    'upload.area.sub':'hoặc <span id="browseBtn">chọn file</span> từ máy tính',
    'upload.area.title':'Kéo thả file vào đây',
    'upload.btn_upload':'Tải lên',
    'upload.clear_done':'Xoá đã xong',
    'upload.guide.cleanup':'File sẽ bị xoá sau khi xử lý',
    'upload.guide.file_types':'Loại file:',
    'upload.guide.max_size':'File tối đa 50MB mỗi file',
    'upload.guide.notes':'Lưu ý:',
    'upload.guide.orders':'<strong>Orders</strong> — dữ liệu đơn hàng',
    'upload.guide.platforms':'Sàn được hỗ trợ:',
    'upload.guide.shopee':'Shopee — file xuất từ Seller Centre',
    'upload.guide.sub':'Hệ thống tự động nhận diện sàn và loại dữ liệu',
    'upload.guide.title':'Hướng dẫn',
    'upload.guide.traffic':'<strong>Traffic</strong> — lượt xem, lượt truy cập',
    'upload.guide.upsert':'Dữ liệu trùng sẽ được cập nhật (upsert)',
