...
$pdo->exec('CREATE TABLE reconcile_combo_items (platform TEXT, combo_sku TEXT, combo_name TEXT, single_sku TEXT, single_qty REAL)');
...
$pdo->exec("INSERT INTO reconcile_combo_items VALUES
    ...
    ('shopee', 'COMBO-MIX', 'Combo mix ba vị', 'SKU-A', 1),
    ('shopee', 'COMBO-MIX', 'Combo mix ba vị', 'SKU-B', 2),
    ('shopee', 'COMBO-MIX', 'Combo mix ba vị', 'SKU-C', 3)");

$expander = new SkuExpander($pdo);
$expanded = $expander->expandAndAggregate([
...
$checks = [
    ...
    array_column($mix, 'product_name') === ['Sản phẩm A', 'Sản phẩm B', 'Sản phẩm C'],
